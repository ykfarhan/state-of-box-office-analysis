...
import numpy as np
import time
#I couldnt get webscraping to work on vgcharts.com but I found a kaggle dataset that used this code. however its not working rn redo it
pages = 19
rec_count = 0
rank = []
gname = []
...
for page in range(1, pages):
    ...
    game_tags = list(filter(lambda x: x.attrs['href'].startswith('https://www.vgchartz.com/game'), soup.find_all("a")))[10:]
